...
urlpatterns = [
    ...
    path('edit_staff/<str:staff_id>',HodViews.edit_staff, name='logout'),    
    path('edit_staff_save',HodViews.edit_staff_save, name='logout'),    
    path('edit_student/<str:student_id>',HodViews.edit_student, name='logout'),    
    path('edit_student_save',HodViews.edit_student_save, name='logout'),
